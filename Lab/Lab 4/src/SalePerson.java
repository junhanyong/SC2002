public class SalePerson implements Comparable {
    ...
    public int compareTo(Object o){
        if (totalSales < ((SalePerson) o).getTotalSales()) return -1;
        else if (totalSales > ((SalePerson) o).getTotalSales()) return 1;
        else {
            if (lastName.compareTo(((SalePerson) o).getLastName()) < 0) return 1;
            else return -1;
        }
    }
